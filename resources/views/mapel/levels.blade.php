...
@section('content')
    <div class="max-w-4xl mx-auto flex flex-col min-h-[75vh] relative z-20 py-10 px-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6 animate-pop-in delay-200">
            @if ($kelas == 'Kelas 1' && $slug == 'bahasa-indonesia')
                <a href="{{ route('mapel.indo.1.1') }}"
                    class="bg-[#12A0D7] rounded-[30px] p-6 shadow-[0_6px_0_#0e82b0] hover:-translate-y-1 hover:shadow-[0_8px_0_#0e82b0] active:translate-y-2 active:shadow-[0_0px_0_#0e82b0] transition-all flex flex-col items-center justify-center text-center no-underline border-4 border-white h-48">
