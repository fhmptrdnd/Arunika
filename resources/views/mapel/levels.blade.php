...
<div class="max-w-4xl mx-auto flex flex-col min-h-[75vh] relative z-20 py-10 px-6">
    ...
    <div class="flex items-center justify-between mb-12 animate-slide-up bg-white p-6 rounded-[30px] shadow-lg">
        <div class="flex items-center gap-4">
            <a href="{{ url()->previous() }}" class="w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center text-xl hover:bg-gray-200 transition-colors no-underline">
                ←
            </a>
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-6 animate-pop-in delay-200">
        ...
        <a href="{{ route('placeholder') }}" class="bg-[#12A0D7] rounded-[30px] p-6 shadow-[0_6px_0_#0e82b0] hover:-translate-y-1 hover:shadow-[0_8px_0_#0e82b0] active:translate-y-2 active:shadow-[0_0px_0_#0e82b0] transition-all flex flex-col items-center justify-center text-center no-underline border-4 border-white h-48">
        ...
        @for($i = 2; $i <= 8; $i++)
        <div class="bg-gray-200 rounded-[30px] p-6 shadow-[0_6px_0_#cbd5e1] flex flex-col items-center justify-center text-center border-4 border-white h-48 opacity-75 cursor-not-allowed">
