    ...
    <div
        ...
        <div class="flex items-start gap-4 md:gap-6 w-[95%] max-w-4xl mb-8 relative z-10">
            ...
            <div class="flex flex-col gap-4 md:gap-5 pt-1">
                <div
                    class="w-12 h-22 md:w-16 md:h-26 bg-white/70 backdrop-blur-sm border-4 border-white rounded-[20px] flex items-center justify-center font-black text-2xl md:text-3xl text-blue-900 shadow-md">
                    1
                </div>
                <div
                    class="w-12 h-22 md:w-16 md:h-26 bg-white/70 backdrop-blur-sm border-4 border-white rounded-[20px] flex items-center justify-center font-black text-2xl md:text-3xl text-blue-900 shadow-md">
            ...
            <div id="sortable-list"
                class="flex flex-col gap-4 md:gap-5 flex-1 relative bg-white/30 backdrop-blur-sm p-4 rounded-4xl border-4 border-dashed border-white/60">
                <!-- Item diisi oleh JS -->
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function initGame() {
            ...
            shuffledCards.forEach((sila) => {
                ...
                card.className =
                    `sortable-item ${sila.color} ${sila.border} border-4 rounded-[20px] w-full h-22 md:h-26 flex items-center p-3 md:p-4 shadow-[0_6px_0_rgba(0,0,0,0.15)] cursor-grab relative z-20`;
        ...
        function tryGrabCard() {
            ...
            if (closestCard) {
                ...
                placeholder.className =
                    "placeholder-slot w-full h-22 md:h-26 rounded-[20px] border-4 border-dashed border-white/80 bg-white/20 transition-all";
